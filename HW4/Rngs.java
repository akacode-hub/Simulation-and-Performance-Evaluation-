...
public class Rngs {
	...
	public void plantSeeds(long x) {
		 ...
		 * with all states dictated by the state of the default stream. The
		 * sequence of planted states is separated one from the next by
	...
	public void putSeed(long x) {
		/*
		 * --------------------------------------------------------------- Use
		 * this function to set the state of the current random number generator
		 * stream according to the following conventions: if x > 0 then x is the
		 * state (unless too large) if x < 0 then the state is obtained from the
		 * system clock if x = 0 then the state is to be supplied interactively
		 * ---------------------------------------------------------------
		 */
		boolean ok = false;
	...
	public long getSeed() {
		/*
		 * --------------------------------------------------------------- Use
		 * this function to get the state of the current random number generator
		 * stream.
		 * ---------------------------------------------------------------
		 */
		return seed[stream];
